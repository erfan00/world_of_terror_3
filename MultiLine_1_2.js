...
var margin_l_1_2 = {top_l_1_2: 20, right_l_1_2: 270, bottom_l_1_2: 30, left_l_1_2: 100},
    width_l_1_2 = 870 - margin_l_1_2.right_l_1_2 - margin_l_1_2.left_l_1_2,
...
d3.csv("data/output_new_2_remove_top3.csv", function(error, data){
    ...
    var path = country.append("path")
      ...
      .on("mouseover", function(d) { 
          ...
          svg_l_1_2.selectAll("text.text_country" + d.name.substring(0, 4)).style("opacity", "1");})
//      .append("svg:title")
//      .text(function(d) {return "Country: " + d.name;})
      .on("mouseout", function(d) {
          d3.select(this).style("stroke-width", "1.5px");
          svg_l_1_2.selectAll("text.text_country" + d.name.substring(0, 4)).style("opacity", "0.1");});
...
//        });
    ...
    country.append("text")
      ...
      .attr("transform", function(d) { return "translate(" + x_l_1_2(d.value.year) + "," + y_l_1_2(d.value.killed) + ")"; })
